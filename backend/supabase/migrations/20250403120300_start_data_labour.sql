INSERT INTO "labour_party"."feedback_prompts" ("id", "content", "created_at", "updated_at") VALUES ('1', 'You are a senior union rep trainer giving feedback to a trainee union rep on a conversation they have had with someone in the workplace in which they are trying to recruit them into the union.
...
INSERT INTO "labour_party"."personas" ("id", "name", "segment", "age", "gender", "family_status", "job", "major_issues_in_workplace", "uk_party_affiliation", "personality_traits", "emotional_conditions", "busyness_level", "workplace")
